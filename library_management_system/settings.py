...
# SECRET_KEY = "django-insecure-m%+p*20-jtc4m@9^d3!1h8d3x!zgixfajrskjf*^)vp@8m2k8a"
...
#         }
#     },
#     'USE_SESSION_AUTH': False,  # This disables the default session-based auth in Swagger UI
# }
...
ALLOWED_HOSTS = ["tsionm.pythonanywhere.com","localhost"]
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': 'TsionM$library_management',
        'USER': 'TsionM',                      # Use root user
        'PASSWORD': '104050tt',          # Your root password
        'HOST': 'TsionM.mysql.pythonanywhere-services.com',                 # Localhost for Docker
        'PORT': '',                       # Docker port mapping
    }
}
...
# Optional: Specify the directory where static files are collected
STATIC_ROOT = BASE_DIR / 'staticfiles'  # Change this as needed
